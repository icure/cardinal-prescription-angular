export const prescriptionTranslations = {
  ...
  nl: {
    ...
    pdf: {
      ...
      instructions:
        'Gelieve dit document aan uw apotheker te tonen zodat hij/zij de barcode kan scannen en de voorgeschreven geneesmiddelen kan afleveren.',
      options: {
        title:
          'Welke opties hebt u om naar de apotheek te gaan als u dit document bent verloren?',
        option1:
          'Via Masanté.be - MyHealthViewer - MijnGeneesmiddelen-app of een andere app, kunt u uw voorschrift tonen aan de apotheker, die de barcode zal scannen.',
        option2:
  ...
  de: {
    ...
    pdf: {
      ...
      instructions:
        'Bitte legen Sie dieses Dokument Ihrem Apotheker vor, damit er den Barcode scannen und die verschriebenen Medikamente abgeben kann.',
      options: {
        title:
          'Welche Möglichkeiten haben Sie, wenn Sie dieses Dokument verloren haben?',
        option1:
          'Über Masanté.be – MyHealthViewer – MeineMedikamente-App oder eine andere App können Sie Ihr Rezept dem Apotheker zeigen, der den Barcode scannt.',
        option2:
