export const deliveryModusTranslations = {
  ...
  en: {
    specifications: {
      ...
      Sp1: 'First prescription by specialist, follow-up prescription by general practitioner',
      'Sp/S': 'Prescription by specialist',
      'Sp1/S':
        'First prescription by specialist, follow-up prescription by general practitioner',
