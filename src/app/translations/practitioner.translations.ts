export const practitionerTranslations = {
  ...
  en: {
    certificateUpload: {
      ...
      passwordMissingDescription:
        'Please enter the password associated with the certificate to decrypt it. This password is required to continue verification.',
    },
    certificateFeedback: {
      successTitle: 'Certificate upload successful',
      successDescription:
        'The practitioner’s certificate was uploaded successfully and the password has been securely saved. You may proceed with the next steps.',
  ...
  nl: {
    ...
    certificateFeedback: {
      ...
      successDescription:
        'Het certificaat van de zorgverlener is succesvol geüpload en het wachtwoord is veilig opgeslagen. U kunt nu doorgaan met de volgende stappen.',
